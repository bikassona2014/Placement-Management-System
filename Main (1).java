...
void display()
{
System.out.println("Presenting the gem recruiters of UNIVERSITY INSTITUTE OF TECHNOLOGY BURDWAN-2022 BATCH");
...
void department()
{
System.out.println("UIT BURDWAN B.E course offers different departments");
...
System.out.println("\tApplied Electronic and Instrumentation Engineering");

System.out.println("\tCivil Engineering");
System.out.println("BURDWAN UNIVERSITY also offers Applied Sciences, MBA, MCA and Pharmacy departments");
...
System.out.println("WELCOME TO THE PLACEMENT CELL OF UNIVERSITY INSTITUTE OF TECHNOLOGY BURDWAN");
System.out.println("A place that gives wings to uitian's dream every year");
System.out.println("UIT offers you different departments like CSE / ECE AND OTHERS ");
